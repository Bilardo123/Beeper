 ...
 */
public class fragmentKritikSaran1 extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance)
    {
        View view = inflater.inflate(R.layout.fragment_kritik_dan_saran1, container, false);
        ButterKnife.bind(this, view);
        return view;
    }

    @OnClick(R.id.btnHubungiSidebeepPengaturan1)
    public void onClick()
    {
