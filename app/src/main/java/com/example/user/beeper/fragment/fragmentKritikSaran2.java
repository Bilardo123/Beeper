 ...
 */
public class fragmentKritikSaran2 extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance)
    {
        View view = inflater.inflate(R.layout.fragment_kritik_dan_saran2, container, false);
        ButterKnife.bind(this, view);
        return view;
    }

    @OnClick(R.id.btnHubungiSidebeepPengaturan2)
    public void onClick()
    {
